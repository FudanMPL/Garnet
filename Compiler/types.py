...
class sint(_secret, _int):
    ...
    @read_mem_value
    @vectorize
    def change_domain_from_to(self, k1, k2, bit_length=None, is_malicious=False):
        """ change to another domain  """
        if k1 < k2:
            if is_malicious:
                res = self - self.round(k1+2, k1, nearest=True) * 2**k1
            else:
...
class sfix(_fix):
    ...
    def change_domain_from_to(self, k1, k2, bit_length=None, is_malicious=False):
        temp = self.v.change_domain_from_to(k1, k2, bit_length, is_malicious)
...
class Array(_vectorizable):
    ...
    def change_domain_from_to(self, k1, k2, bit_length=None, is_malicious=False):
        return self.get_vector().change_domain_from_to(k1, k2, bit_length, is_malicious)
