...
class FERplus(Dataset):
    ...
    def _load(self):
        ...
        path_folders_images = path.join(self.base_path_to_FER_plus, self.fer_sets[self.idx_set])
        path_folders_labels = path.join(self.base_path_to_FER_plus, self.fer_sets[self.idx_set])
