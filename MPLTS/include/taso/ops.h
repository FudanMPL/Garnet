...
public:
  ...
  // MPC INTERFACES
  float mpcCost;
  // static sem_t COST_READY, GRAPH_READY;
  // Graph* graph_to_eval;
  // float cost_to_load;
  bool optimize_next_step(float alpha, int budget);
  void optimize_on_step(float alpha, int budget);
  std::vector<Graph*> transGraphs;
};
