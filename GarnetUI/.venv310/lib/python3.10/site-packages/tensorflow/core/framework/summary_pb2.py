...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[tensorflow_dot_tsl_dot_protobuf_dot_histogram__pb2.DESCRIPTOR,tensorflow_dot_core_dot_framework_dot_tensor__pb2.DESCRIPTOR,],
  public_dependencies=[tensorflow_dot_tsl_dot_protobuf_dot_histogram__pb2.DESCRIPTOR,])
...
_SUMMARY_VALUE.fields_by_name['histo'].message_type = tensorflow_dot_tsl_dot_protobuf_dot_histogram__pb2._HISTOGRAMPROTO
