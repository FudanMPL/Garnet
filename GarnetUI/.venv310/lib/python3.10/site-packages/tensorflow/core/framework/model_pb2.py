...
_NODECLASS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ASYNC_UNKNOWN_RATIO', index=6, number=6,
      serialized_options=None,
      type=None),
  ],
...
_AUTOTUNEALGORITHM = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HILL_CLIMB', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GRADIENT_DESCENT', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MAX_PARALLELISM', index=3, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='STAGE_BASED', index=4, number=4,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
