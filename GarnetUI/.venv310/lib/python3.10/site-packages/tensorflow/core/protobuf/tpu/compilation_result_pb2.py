...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[tensorflow_dot_compiler_dot_xla_dot_service_dot_hlo__pb2.DESCRIPTOR,tensorflow_dot_core_dot_protobuf_dot_error__codes__pb2.DESCRIPTOR,])



_COMPILATIONRESULTPROTO_ERRORCODE = _descriptor.EnumDescriptor(
  name='ErrorCode',
  full_name='tensorflow.tpu.CompilationResultProto.ErrorCode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OUT_OF_MEMORY', index=1, number=1,
      serialized_options=None,
      type=None),
  ],
...
_sym_db.RegisterEnumDescriptor(_COMPILATIONRESULTPROTO_ERRORCODE)
...
_COMPILATIONRESULTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error_code', full_name='tensorflow.tpu.CompilationResultProto.error_code', index=3,
...
_COMPILATIONRESULTPROTO.fields_by_name['status_code'].enum_type = tensorflow_dot_tsl_dot_protobuf_dot_error__codes__pb2._CODE
...
_COMPILATIONRESULTPROTO.fields_by_name['error_code'].enum_type = _COMPILATIONRESULTPROTO_ERRORCODE
_COMPILATIONRESULTPROTO_ERRORCODE.containing_type = _COMPILATIONRESULTPROTO
