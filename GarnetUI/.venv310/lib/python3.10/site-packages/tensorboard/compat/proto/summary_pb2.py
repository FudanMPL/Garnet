...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[tensorboard_dot_compat_dot_proto_dot_histogram__pb2.DESCRIPTOR,tensorboard_dot_compat_dot_proto_dot_tensor__pb2.DESCRIPTOR,],
  public_dependencies=[tensorboard_dot_compat_dot_proto_dot_histogram__pb2.DESCRIPTOR,])
...
_SUMMARY_VALUE.fields_by_name['histo'].message_type = tensorboard_dot_compat_dot_proto_dot_histogram__pb2._HISTOGRAMPROTO
